...
import org.technicalpi.blights.*;
import org.technicalpi.blights.CursedBank;
import org.technicalpi.blights.CursedFlame;
import org.technicalpi.blights.MegaStarOfAscension;
import org.technicalpi.blights.StarOfAscension;
import org.technicalpi.cards.AscendersBane;
...
EditCardsSubscriber
{
    ...
    public void receivePostInitialize() {
    	...
    	try {
			config = new SpireConfig("org/technicalpi", "config", defaults);
		} catch (IOException e) {
			e.printStackTrace();
		}
    ...
    public void receiveEditCards() {
        ...
        try {
        	BaseMod.addCard(new AscendersBane());
        } 
        catch (Exception e) {
