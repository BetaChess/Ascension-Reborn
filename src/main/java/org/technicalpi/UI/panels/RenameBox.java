package org.technicalpi.UI.panels;
...
public class RenameBox {
    ...
    private void renderTextbox(final SpriteBatch sb) {
        ...
        FontHelper.renderSmartText(sb, FontHelper.SCP_cardTitleFont_small, RenameBox.textField, Settings.WIDTH / 2.0f - 120.0f * Settings.scale, Settings.OPTION_Y + 24.0f * Settings.scale, 100000.0f, 0.0f, this.uiColor);
        final float tmpAlpha = (MathUtils.cosDeg(System.currentTimeMillis() / 3L % 360L) + 1.25f) / 3.0f * this.uiColor.a;
        FontHelper.renderSmartText(sb, FontHelper.SCP_cardTitleFont_small, "_", Settings.WIDTH / 2.0f - 122.0f * Settings.scale + FontHelper.getSmartWidth(FontHelper.SCP_cardTitleFont_small, RenameBox.textField, 1000000.0f, 0.0f), Settings.OPTION_Y + 24.0f * Settings.scale, 100000.0f, 0.0f, new Color(1.0f, 1.0f, 1.0f, tmpAlpha));
    }
    ...
    private void renderButtons(final SpriteBatch sb) {
        ...
        c.a = this.uiColor.a;
        // TODO: LOOK AT TEXT
        FontHelper.renderFontCentered(sb, FontHelper.SCP_cardTitleFont_small, RenameBox.TEXT[2], Settings.WIDTH / 2.0f - 110.0f * Settings.scale, Settings.OPTION_Y - 118.0f * Settings.scale, c, 1.0f);
        ...
        c.a = this.uiColor.a;
        FontHelper.renderFontCentered(sb, FontHelper.SCP_cardTitleFont_small, RenameBox.TEXT[3], Settings.WIDTH / 2.0f + 110.0f * Settings.scale, Settings.OPTION_Y - 118.0f * Settings.scale, c, 1.0f);
