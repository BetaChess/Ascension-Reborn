...
public class BattleRewardPatch {
	...
	public static class RicherBosses {
		...
		public static void Insert(AbstractRoom __instance, @ByRef int[] tmp) {
			if (AscensionMod.AbsoluteAscensionLevel <= -8 || AscensionMod.getCustomToggleState(-8))
	...
	public static class GainMaxHpAfterBoss {
		...
		public static void Insert(AbstractRoom __instance) {
			if (__instance instanceof MonsterRoomBoss) {
				if (AscensionMod.AbsoluteAscensionLevel <= -11 || AscensionMod.getCustomToggleState(-11))
	...
	public static class NormalEnemiesDropRelic {
		...
		public static void Insert(AbstractRoom __instance) {
			if (AscensionMod.AbsoluteAscensionLevel <= -14 || AscensionMod.getCustomToggleState(-14))
	...
	public static class ElitesDropCard {
		...
		public static void Insert(AbstractRoom __instance) {
			if (AscensionMod.AbsoluteAscensionLevel <= -15 && __instance instanceof MonsterRoomElite  || (AscensionMod.getCustomToggleState(-15) && __instance instanceof MonsterRoomElite))
	...
	public static class BossDropRelic {
		@SpireInsertPatch(rloc = 107)
		public static void Insert(AbstractRoom __instance) {
			if (AscensionMod.AbsoluteAscensionLevel <= -16 && __instance instanceof MonsterRoomBoss  || (AscensionMod.getCustomToggleState(-16) && __instance instanceof MonsterRoomBoss))
	...
	public static class RewardsContainPotion {
		...
		public static void Insert(AbstractRoom __instance) {
			if (AscensionMod.AbsoluteAscensionLevel <= -17  || AscensionMod.getCustomToggleState(-17))
